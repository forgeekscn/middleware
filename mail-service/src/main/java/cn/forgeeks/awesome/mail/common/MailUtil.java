package cn.forgeeks.awesome.mail.common;
...
public class MailUtil {
    ...
    public void sendSimpleMail(MailBean mailBean) {
        ...
        logger.info("Mail sended successfuly.[{}]", mailBean);
    }
    ...
    public void sendAttachmentMail(MailBean mailBean) {
        ...
        try {
            ...
            FileSystemResource file = new FileSystemResource(new File("src/main/resources/static/image/common.png"));
            mimeMessageHelper.addAttachment("common.png", file);
            javaMailSender.send(mimeMailMessage);
        } catch (Exception e) {
            logger.error("邮件发送失败", e.getMessage());
        }
    ...
    public void sendTemplateMail(MailBean mailBean) {
        ...
        try {
            ...
            Template template = configuration.getTemplate("common.ftl");
